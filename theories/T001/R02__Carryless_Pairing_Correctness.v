...
Section Carryless_Correctness.
  ...
  *)
  ...
  Proof.
    ...
    assert (Hx : sum_fib (half_even_indices zn) = x).
    - subst zn.
      apply sum_fib_half_even_pair.
    - assert (Hy : sum_fib (y_indices (B P x) zn) = y).
      + subst zn.
        apply sum_fib_y_indices_pair.
      + rewrite Hx.
        rewrite Hy.
        reflexivity.
  Qed.
