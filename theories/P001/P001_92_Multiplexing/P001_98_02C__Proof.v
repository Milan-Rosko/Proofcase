...
└──────────────────────────────────────────────────────────────────────────────┘
┌──────────────────────────────────────────────────────────────────────────────┐
│                        Proofcase / P001_98_02C__Proof                        │
└──────────────────────────────────────────────────────────────────────────────┘

  OVERVIEW

  This file proves the peeled goals using lemmas for the 2-adic core, the
  finite odd codomain, the collision step, and the divisibility orientation.
  It exports the endpoint witness.

*)

From P001.P001_98_Multiplexing Require Export P001_98_02A__Peeling.
...
(*
│
│          This helper block proves the two-adic factorization
│          obligation used by the final peeled package. The individual
│          lemmas are local scaffolding for that exported endpoint.
│
*)
...
(*
│
│          This helper block proves the finite odd-domain obligation.
│          Its list and cardinality lemmas support the exported
│          domain-exhaustion theorem below.
│
*)
...
(*
│
│          This helper block proves the odd-core collision and
│          divisibility-orientation obligations. The intermediate
│          lemmas are the finite pigeonhole scaffolding.
│
*)
...
Theorem the_four_conjectures_hold :
  first_expansion.
Proof.
  destruct peeling_package_holds as
      [Hfactor [Hdomain [Hcollision Horient]]].
  intros n A Hselection.
  destruct Hselection as [Hbounds [Hnodup Hlen]].
  split.
  - intros x Hx_pos Hx_bound.
    exact (Hfactor n x Hx_pos Hx_bound).
  - split.
    + exact (Hdomain n).
    + split.
      * exact (Hcollision n A Hbounds Hnodup Hlen).
