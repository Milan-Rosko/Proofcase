...
(*@doc.pl@[[Minimal symbolic-regulator vocabulary shared with L002.  A
symbolic regulator contains only an output type, an instruction type, and a
Boolean acceptance function.  It adds no proof search, semantic
interpretation, world structure, closure adapter, or evaluation principle.]]@*)
