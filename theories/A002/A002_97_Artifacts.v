...
└──────────────────────────────────────────────────────────────────────────────┘
  ...
  Artifact layer for A002. We record assumption reports for the public
  verifier and checker theorems, then extract the arithmetic verifier,
  certificate checker, constructors, parsers, rule checkers, and IO
  dispatcher to OCaml.
...
Redirect "theories/A002/_appendix/_assumptions/A002_Verify_accept_sound"
  Print Assumptions A002_Verify_accept_sound.

Redirect "theories/A002/_appendix/_assumptions/A002_generated_cert_checks"
  Print Assumptions A002_generated_cert_checks.
