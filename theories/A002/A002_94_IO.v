...
(*
│
│          The compact view changes presentation only: natural-number
│          payloads are converted to binary integers after the
│          underlying arithmetic command has run. It does not alter
│          validation, normalization, status conventions, or error
│          selection.
│
*)
