...
(*@doc.pl@[[This phase introduces only the degree-2 target language needed for Step A of the quartic roadmap. It mirrors the existing cubic-family surface, but does not yet perform any reduction from cubic families.]]@*)

(*@doc.pl@[[The role of this file is deliberately narrow: define quadratic monomials, terms, equations, well-formedness, semantics, family satisfiability, and the basic list lemmas that later constructive reductions will need.]]@*)
