...
└──────────────────────────────────────────────────────────────────────────────┘
┌──────────────────────────────────────────────────────────────────────────────┐
│                   Proofcase / P002_12__Cubic_To_Quadratic                    │
└──────────────────────────────────────────────────────────────────────────────┘

  OVERVIEW

  This file starts Step A of the quartic roadmap by fixing a concrete
  constructive reduction from cubic families to quadratic families. The
  present phase sets up the transformation data and proves structural lemmas
  about fresh-variable allocation and family size.

  No semantic equivalence claim is stated here yet beyond what is proved
  below. The goal of this pass is to make the reduction executable and its
  bookkeeping explicit before the bidirectional correctness theorem is added.
