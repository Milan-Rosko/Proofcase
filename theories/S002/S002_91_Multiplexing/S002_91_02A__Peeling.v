...
└──────────────────────────────────────────────────────────────────────────────┘
┌──────────────────────────────────────────────────────────────────────────────┐
│                       Proofcase / S002_91_02A__Peeling                       │
└──────────────────────────────────────────────────────────────────────────────┘

  OVERVIEW

  This file names the four mathematical obligations used by the multiplexing
  presentation: 2-adic factorization, odd-domain exhaustion, odd-core
  collision, and divisibility orientation.
...
(*
│
│          The four named obligations form one peeling package.
│
*)
